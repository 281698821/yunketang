        ...
        <form class="layui-form" id="search-form">
            <div class="layui-form-item hp-form-item">
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">活动地址：</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <input type="text"  name="activityaddress"  placeholder="请输入要查询的地址"
                               autocomplete="off" class="layui-input">
                    </div>
                </div>

                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">组织人：</label>
                    <div class="layui-input-inline" style="width: 150px;">
...
<div class="layui-btn-group demoTable">
    ...
    <button id="inform" class="layui-btn hp-btn-release">

        ...
        <form class="layui-form" id="search-form">
            <div class="layui-form-item hp-form-item">
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">名字：</label>
                ...
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">性别:</label>
                    <div class="layui-input-inline" style="width: 150px;">
...
<div class="layui-btn-group demoTable">
    ...
    <button id="sendOffer" class="layui-btn hp-btn-yellow" style="color: #FFFF00">
        <i class="layui-icon">&#xe602;</i>发送offer
    </button>
</div>
<!-- 数据表格 -->
...
<script type="text/html" id="barTool">
    <a class="layui-btn layui-btn-enroll layui-btn-xs" lay-event="sendOffer">发送offer</a>
    <a class="layui-btn layui-btn-enroll layui-btn-xs" lay-event="enrollEmp">录取员工</a>
...
<script src="/js/applicant/list.js"></script>
</body>
</html>

    ...
    <blockquote class="layui-elem-quote">
        <form class="layui-form" id="search-form">
                ...
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">部门名称：</label>
                    <div class="layui-input-inline" style="width: 150px;">
                        <select name="name" lay-verify="">
                            <option value="">部门名称</option>
                            <c:forEach items="${deptNames}" var="deptName">
                                <option value="${deptName.name}">${deptName.name}</option>
                            </c:forEach>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">公司名称：</label>
                        <div class="layui-input-inline" style="width: 150px;">
                            <select name="companyName" lay-verify="">

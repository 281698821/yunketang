        ...
        <form class="layui-form" id="search-form">
            <div class="layui-form-item hp-form-item">
                <div class="layui-inline hp-form-inline">
                    ...
                    <div class="layui-inline hp-form-inline">
                        <label class="layui-form-label hp-form-label">需求人数:</label>
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="text" name="begin" placeholder="人数" autocomplete="off" class="layui-input">
                        </div>
                        <div class="layui-form-mid">-</div>
                        <div class="layui-input-inline" style="width: 150px;">
                            <input type="text" name="end" placeholder="人数" autocomplete="off" class="layui-input">
                        </div>
                    </div>
...
<script src="/js/recruitmentdemand/list.js"></script>
</body>
</html>

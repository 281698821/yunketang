        ...
        <form class="layui-form" id="search-form">
            <div class="layui-form-item hp-form-item">
                <div class="layui-inline hp-form-inline">
                    <label class="layui-form-label hp-form-label">姓名：</label>
...
<div class="layui-btn-group demoTable">
    ...
    <button id="offer" class="layui-btn layui-btn-warm">
        <i class="layui-icon"></i>面试邀请
    </button>
</div>
...
<script src="/js/talentpool/list.js"></script>
</body>
</html>

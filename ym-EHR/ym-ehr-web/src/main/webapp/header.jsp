...
<div id="loginmain">
    ...
    <c:if test="${EMP_IN_SESSION.id!=null}">
        <img class="img-thumbnail"style="height:40px;width:40px" src="${EMP_IN_SESSION.img}" ><span>&nbsp;欢迎你！${EMP_IN_SESSION.name}</span>
    </c:if>

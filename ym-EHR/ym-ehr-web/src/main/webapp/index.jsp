...
<section class="feature" id="listed">
                        ...
                        <div class="item">
                            <div style="/*background-image: url(img/agent1.jpg);*/ height: 150px ;width: 300px;">
                                <video controls="controls">
                                    <source src="https://www.runoob.com/try/demo_source/movie.ogg" type="video/oog"> 您的浏览器不支持此种视频格式。
                                </video>
                            </div>
                            <div class="img-info">
    ...
    <div style="margin-left: 1000px;"><button type="button" class="btn btn-default btn-sm">小的默认按钮</button></div>
</section>
                    ...
                    <div class="quotes text-left">
                        <blockquote>
                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer lorem quam, adipiscing condimentum tristique vel,
                                <br> eleifend sed turpis. Pellentesque cursus arcu id magna euismod in elementum purus molestie.</p>

    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable= table.render({
                ...
                cols: [[
                    ...
                    {field: 'empname', align: 'center', title: '对应员工'},
                    {field: 'shouldsend', align: 'center', title: '应发工资'},
                    {field: 'bonus', align: 'center', title: '奖金'},
                    {field: 'fine', align: 'center', title: '罚款'},
                    {field: 'insured', align: 'center', title: '投保'},
                    {field: 'time', align: 'center', title: '发放时间'},
                    {field: 'realhair', align: 'center', title: '实发工资'},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpWindow.openOne(".updateBtn", "/articlewages/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '550px'],
                        btn: ['确认', '取消'],
                        anim: 1,
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                location.href = '/articlewages/export';
            });
            ...
            // 发送邮件
            $('#send').click(function () {
                layer.confirm('发送工资条吗', function (index) {
                        $.ajax({
                            url: '/articlewages/sent',
                            type: 'post',
                            dataType: 'json',
                            success: function (json) {
                                if(json) {

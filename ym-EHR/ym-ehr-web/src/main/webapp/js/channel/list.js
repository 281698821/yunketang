    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable= table.render({
                elem: '#dataTable',
                url: "/channelController/ajaxList",
                cellMinWidth: 80,
                showLoad: true,
                page: true,
                loading:false,
                cols: [[
                    ...
                    {field: 'name', align: 'center', title: '渠道名称或地址'},
                    {field: 'addtime', align: 'center', title: '渠道上传时间'},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpWindow.openOne(".updateBtn", "/channelController/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '550px'],
                        btn: ['确认', '取消'],
                        anim: 1,
                        success: function (layero, index) {
                            ...
                            form.on('submit(save)', function (data) {
                                ...
                                $.ajax({
                                    url: '/channelController/saveUpdate',
                                    data: data,
                                    type: 'post',
                                    dataType: 'json',
                                    success: function (json) {
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                ...
                location.href = '/channelController/export';
        ...
        initOpenWindow: function () {
            // 添加弹窗
            hpWindow.open("#addBtn", "/channelController/saveUpdatePage", {
                title: '添加',
                area: ['550px', '550px'],
                btn: ['确认', '取消'],
                anim: 1,

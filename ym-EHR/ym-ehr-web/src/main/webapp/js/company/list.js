...
// layui初始化模块使用
layui.use(['table', 'hpWindow','utils','hpFormAll','layer'], function () {
    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable=table.render({
                elem: '#dataTable'
                ,url:'/companyController/ajaxList'
                ,title: '用户数据表'
                ,page: true
                ,cols: [[
                    {type: 'checkbox', fixed: 'left'}
                    ,{field:'name', title:'公司名称', sort: true}
                    ,{field:'address', title:'公司所在地',}
                    ,{field:'mark', title:'公司备注',sort: true,}
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpFormAll.open("#updateBtn","/companyController/saveUpdatePage?id="+data.id,'修改公司信息');
                    /*hpWindow.openOne(".updateBtn", "/companyController/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '340px'],
                        btn: ['确认', '取消'],
                        anim: 1,
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                location.href = '/companyController/export';
            });
            // 批量删除
        ...
        initOpenWindow: function () {
            hpFormAll.open("#addBtn","/companyController/saveUpdatePage",'添加公司信息');
            // 添加弹窗
            /*hpWindow.open("#addBtn", "/companyController/saveUpdatePage", {
                title: '添加',
                area: ['550px', '340px'],
                btn: ['确认', '取消'],
                anim: 1,

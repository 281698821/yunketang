    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable=table.render({
                ...
                ,cols: [[
                    ...
                    {field: 'company', templet: cmd.fmt.companyFmt, align: 'center', title: '所属公司',},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpFormAll.open(".updateBtn","/deptController/saveUpdatePage?id=" + data.id,'修改部门信息');
                    /*hpWindow.openOne(".updateBtn", "/deptController/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '400px'],
                        btn: ['确认', '取消'],
                        anim: 1,
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                location.href = '/deptController/export';
            });
        ...
        initOpenWindow: function () {
            ...
            hpFormAll.open("#addBtn","/deptController/saveUpdatePage",'添加部门信息');
            // 添加弹窗
           /* hpWindow.open("#addBtn", "/deptController/saveUpdatePage", {
                title: '添加',
                area: ['550px', '400px'],
                btn: ['确认', '取消'],
                anim: 1,

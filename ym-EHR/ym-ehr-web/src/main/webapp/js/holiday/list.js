    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable= table.render({
                elem: '#dataTable',
                url: "/holidayController/ajaxList",
                cellMinWidth: 80,
                showLoad: true,
                page: true,
                loading:false,
                cols: [[
                    ...
                    {field: 'name', align: 'center', title: '节日名称'},
                    {field: 'time', align: 'center', title: '日期'},
                    {field: 'content', align: 'center', title: '祝福语'},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpWindow.openOne(".updateBtn", "/holidayController/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '550px'],
                        btn: ['确认', '取消'],
                        anim: 1,
                        success: function (layero, index) {
                            ...
                            form.on('submit(save)', function (data) {
                                ...
                                $.ajax({
                                    url: '/holidayController/saveUpdate',
                                    data: data,
                                    type: 'post',
                                    dataType: 'json',
                                    success: function (json) {
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                location.href = '/holidayController/export';
            });
        ...
        initOpenWindow: function () {
            // 添加弹窗
            hpWindow.open("#addBtn", "/holidayController/saveUpdatePage", {
                title: '添加',
                area: ['550px', '550px'],
                btn: ['确认', '取消'],
                anim: 1,

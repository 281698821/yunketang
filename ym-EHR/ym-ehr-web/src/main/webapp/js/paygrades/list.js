    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable= table.render({
                ...
                cols: [[
                    ...
                    {field: 'salary', align: 'center', title: '对应工资'},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpWindow.openOne(".updateBtn", "/paygrades/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '550px'],
                        btn: ['确认', '取消'],
                        anim: 1,
        ...
        bindEvent: function () {
            ...
            $("#export").click(function () {
                location.href = '/paygrades/export';
            });
        ...
        initOpenWindow: function () {
            // 添加弹窗
            hpWindow.open("#addBtn", "/paygrades/saveUpdatePage", {
                title: '添加',
                area: ['550px', '550px'],
                btn: ['确认', '取消'],
                anim: 1,

...
layui.use(['table', 'hpWindow','utils','laydate'], function () {
    ...
    var cmd = {
        ...
        initEvent: function () {
            ...
            dataTable= table.render({
                ...
                cols: [[
                    ...
                    {field: 'rulesname', width: 100,align: 'center', title: '规则名称'},
                    {field: 'clockinnum', align: 'center', title: '打卡次数'},
                    {field: 'amstarttime', align: 'center', title: '上午上班打卡时间'},
                    {field: 'amendtime', align: 'center', title: '下午下班打卡时间'},
                    {field: 'pmstarttime', align: 'center', title: '下午上班打卡时间'},
                    {field: 'pmendtime', align: 'center', title: '下午下班打卡时间'},
                    {field: 'clockiniocation', align: 'center', title: '打卡位置'},
                    {field: 'instructions', align: 'center', title: '备注'},
                    {field: 'empId', templet: cmd.fmt.empName, align: 'center', title: '规则发布人'},
            ...
            table.on('tool(tableTool)', function (obj) {
                ...
                if (obj.event === 'del') {
                    ...
                    hpWindow.openOne(".updateBtn", "/rule/saveUpdatePage?id=" + data.id, {
                        title: '修改',
                        area: ['550px', '550px'],
                        btn: ['确认', '取消'],
                        anim: 1,
        ...
        initOpenWindow: function () {
            // 添加弹窗
            hpWindow.open("#addBtn", "/rule/saveUpdatePage", {
                title: '添加',
                area: ['550px', '550px'],
                btn: ['确认', '取消'],
                anim: 1,
